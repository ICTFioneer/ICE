sap.ui.define([
  ...
  return Controller.extend("ice.controller.Detail", {
    ...
    _onRouteMatched: function (oEvent) {
      ...
      // inicijalno binduj samo aktivni tab
      this._rebindActive();
    },
    ...
    onSearch: function () {
      // klik na Go u filterbaru na detailu
      this._rebindActive();
    },
    ...
    _getAllFilters: function () {
      ...
      // 1) obavezni filteri iz master selekcije (da detail bude “u kontekstu”)
      ...
      // 2) filteri iz SmartFilterBar (kad dodaš dodatna polja)
